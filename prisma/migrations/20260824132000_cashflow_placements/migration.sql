...
CREATE TABLE "new_CompanySettings" (
    ...
    "urssafDeadlineDay" INTEGER NOT NULL DEFAULT 5,
    "publicodesRegime" TEXT NOT NULL DEFAULT 'AE_BNC_LIBERAL',
    "invoicePrefix" TEXT NOT NULL DEFAULT '',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_CompanySettings" ("addressLine1", "addressLine2", "apeCode", "city", "country", "createdAt", "email", "id", "invoicePrefix", "legalName", "phone", "postalCode", "publicodesRegime", "siren", "siret", "tradeName", "treasuryRateBps", "updatedAt", "urssafRateBps", "vatMention", "vatRegime", "website") SELECT "addressLine1", "addressLine2", "apeCode", "city", "country", "createdAt", "email", "id", "invoicePrefix", "legalName", "phone", "postalCode", "publicodesRegime", "siren", "siret", "tradeName", "treasuryRateBps", "updatedAt", "urssafRateBps", "vatMention", "vatRegime", "website" FROM "CompanySettings";
