...
describe("formatInvoiceNumber", () => {
  it("pads sequence to 3 digits", () => {
    ...
    expect(formatInvoiceNumber(2026, 12)).toBe("2026-012");
    expect(formatInvoiceNumber(2026, 100)).toBe("2026-100");
  });
  ...
  it("keeps continuous sequence simulation without holes", () => {
    ...
    expect(allocated).toEqual(["2026-001", "2026-002", "2026-003", "2026-004", "2026-005"]);
  });
});
